          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-5 space-y-6">
              ...
              <div className="flex items-start gap-5 p-6 border border-slate-100 bg-slate-50/50 rounded-2xl">
                ...
                <div>
                  <h3 className="text-sm font-semibold text-slate-400 uppercase tracking-wider mb-1">Head Office</h3>
                  <p className="text-slate-700 leading-relaxed font-light text-sm sm:text-base">
                    Sky Plaza Business Center, Section D, 1st Floor, Embassy Street 9,
                    13th Microdistrict, 1st Khoroo, Sukhbaatar District,
              ...
              <div className="bg-slate-50 border border-slate-100 rounded-3xl p-8 md:p-10 shadow-sm relative overflow-hidden">
                ...
                {submitted ? (
                  <div className="py-12 flex flex-col items-center text-center animate-in fade-in zoom-in-95 duration-200">
                    ...
                    <h3 className="text-2xl font-bold text-[#0b1e33] mb-2">Submitted Successfully</h3>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-2">
                        <label htmlFor="name" className="text-sm font-semibold text-[#0b1e33]">Name</label>
                        <input
                          id="name"
                          type="text"
                          required
                      ...
                      {/* Phone */}
                      <div className="space-y-2">
                        <label htmlFor="phone" className="text-sm font-semibold text-[#0b1e33]">Phone number</label>
                        <input
                          id="phone"
                          type="tel"
                          required
                    ...
                    {/* Email */}
                    <div className="space-y-2">
                      <label htmlFor="email" className="text-sm font-semibold text-[#0b1e33]">Email address</label>
                      <input
                        id="email"
                        type="email"
                        required
                    ...
                    {/* Message */}
                    <div className="space-y-2">
                      <label htmlFor="message" className="text-sm font-semibold text-[#0b1e33]">Message</label>
                      <textarea
                        id="message"
                        rows={5}
                        required
