...
export const metadata: Metadata = {
  title: "Services - Khimi Consulting",
  description: "Our services",
};

const services = [
  {
    title: "Chemical Trade",
    icon: Package,
  },
  {
    title: "Advice on safe use, storage and warehouse management of chemicals",
    icon: ShieldCheck,
  },
  {
    title: "“Organizing laboratory research and analysis in the field of mining production technology”",
    icon: FlaskConical,
  }
];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl">
            ...
            <p className="text-slate-350 text-lg md:text-xl leading-relaxed font-light">
              We operate professionally in the mining and chemical industries and provide the following services.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {services.map((service, index) => {
              ...
              return (
                <div 
                  key={index} 
                  className="bg-white border border-slate-100 hover:border-emerald-500/20 rounded-3xl p-8 shadow-[0_10px_30px_rgba(0,0,0,0.02)] transition-all duration-300 hover:-translate-y-1 hover:shadow-md flex flex-col items-start group min-h-[280px] justify-between"
                >
